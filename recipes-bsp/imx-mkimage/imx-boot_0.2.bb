...
SC_FIRMWARE_NAME_iwg27m ?= "mx8qm-iwg27m-scfw-tcm.bin"
...
SECO_FIRMWARE ?= ""
SECO_FIRMWARE_mx8qm  = "mx8qm-ahab-container.img"
SECO_FIRMWARE_mx8qxp = "mx8qx-ahab-container.img"
SECO_FIRMWARE_imx8qxpc0mek  = "mx8qxc0-ahab-container.img"
SECO_FIRMWARE_mx8dxl-phantom = "mx8qx-ahab-container.img"
...
compile_mx8() {
    ...
    #cp ${S}/../../../../../../../meta-iwave/recipes-bsp/imx-mkimage/imx-boot/${SC_FIRMWARE_NAME_iwg27m} ${BOOT_STAGING}/scfw_tcm.bin
    cp ${DEPLOY_DIR_IMAGE}/${BOOT_TOOLS}/${SC_FIRMWARE_NAME_iwg27m} ${BOOT_STAGING}/scfw_tcm.bin
    cp ${DEPLOY_DIR_IMAGE}/${BOOT_TOOLS}/${ATF_MACHINE_NAME} ${BOOT_STAGING}/bl31.bin
    cp ${DEPLOY_DIR_IMAGE}/${UBOOT_NAME}                     ${BOOT_STAGING}/u-boot.bin
