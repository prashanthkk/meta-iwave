...
BOARD_TYPE ?= "iwg27m"
SC_FIRMWARE_NAME ?= "mx8qm-iwg27m-scfw-tcm.bin"
...
do_deploy() {
    install -Dm 0644 ${S}/../../../../../../../sources/meta-iwave/recipes-bsp/imx-mkimage/imx-boot/${SC_FIRMWARE_NAME} ${DEPLOYDIR}/${BOOT_TOOLS}/${SC_FIRMWARE_NAME}
